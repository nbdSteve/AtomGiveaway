package gg.steve.mc.lily.ag.framework.actionbarapi;
...
//            e.printStackTrace();
    ...
    public static void sendActionBar(final Player player, final String message, int duration) {
        ...
        if (duration >= 0) {
            ...
            }.runTaskLater(AtomGiveaway.getInstance(), duration + 1);
        }
        ...
        while (duration > 40) {
            ...
            }.runTaskLater(AtomGiveaway.getInstance(), (long) duration);
        }
    }

    public static boolean sendActionBarToAllPlayers(String message) {
        return sendActionBarToAllPlayers(message, -1);
    }

    public static boolean sendActionBarToAllPlayers(String message, int duration) {
        try {
